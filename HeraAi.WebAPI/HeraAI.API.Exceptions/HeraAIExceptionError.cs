namespace HeraAI.API.Exceptions
{
    ...
    public class HeraAIExceptionError : Exception
    {
        ...
        public HeraAIExceptionError(string module, string _class, string origin, string info)
        {
            this.module = module;
            this._class = _class;
            this.origin = origin;
            this.entityKeys = new long?[] { };
            this.info = info;
        }
        ...
        /// <param name="info">Adicional information to help track back the exception</param>
        public HeraAIExceptionError(string module, string _class, string origin, long?[] entityKeys, string info)
        {
            this.module = module;
            this._class = _class;
            this.origin = origin;
        ...
        /// </summary>
        public long?[] EntityKeys { get => entityKeys; set => entityKeys = value; }
