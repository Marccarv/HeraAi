...
namespace HeraAI.API.Exceptions
{
    ...
    public class DbmsErrorException : ApplicationException
    {
        ...
        /// <summary>
        /// Use this method to create a new dbms Exception Error without entity keys
        /// </summary>
        ...
        public DbmsErrorException(string module, string _class, string origin, string info)
        {
            this.module = module;
            this._class = _class;
            this.origin = origin;
        ...
        /// <summary>
        /// Use this method to create a new Cuco Exception Error with entity keys
        /// </summary>
        /// <param name="module">module where the exception was created</param>
        /// <param name="_class">class where the exception was created (if sql error insert "sqldatabase")</param>
        /// <param name="origin">method or stored procedure where the exception was created (if sql error use the name of stored procedure)</param>
        ...
        /// <param name="info">adicional information to help track back the exception</param>
        public DbmsErrorException(string module, string _class, string origin, string[] entityKeys, string info)
        {
            this.module = module;
            this._class = _class;
            this.origin = origin;
        ...
        public object ToJson(bool inProduction)
        {
            ...
            if (inProduction)
            {
                json = "";
                json += "{";
                json += string.Format("\"{0}\" : \"{1}\"", "message", CleanText(info));
                json += "} ";
            }
            else
            {
